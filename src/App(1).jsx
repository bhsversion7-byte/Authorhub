...
export default function App() {
  ...
  const viewKind = activeView === "author" ? "author" : activeView === "user" ? "user" : activeNovel ? "novel" : "empty";
  ...
  return (
    <div className={`app-shell ${privacyBlur ? "privacy-blur" : ""}`}>
      ...
      />
      <main
        className={`content-shell content-shell--${viewKind} font-${appearance.fontFamily ?? "sans"}`}
        style={{ marginLeft: sidebarWidth, "--editor-font-size": `${appearance.fontSize ?? 14}px` }}
      >
        {activeView === "author" && (
          <div className="view-frame view-frame--author">
            <AuthorDashboard
              author={data.author}
              novels={novels}
        ...
        {activeView === "user" && (
          <div className="view-frame view-frame--user">
            <UserCenter
              authUser={authUser}
              author={data.author}
              onAuthorChange={updateAuthor}
        ...
        {activeNovel ? (
          <div className="view-frame view-frame--novel">
            <NovelSection
              key={activeNovel.id}
              novel={activeNovel}
