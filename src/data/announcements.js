export const ANNOUNCEMENTS = [
  {
    ...
    body: [
      "人物关系星图新增了「区域锁定」：按住 Shift 键（Mac 上按 Cmd 键），用鼠标左键拖出一个方框，圈住想固定的几颗星球，松手后右键点一下，选「锁定位置」就行。锁定的星球外面会有一圈淡淡的方形虚线提醒你——之后不管怎么拖动其他星球、新增多少人物，被锁定的这几颗都不会再被打乱位置。想解开就再框一次，右键选「取消锁定」。平时不按修饰键的正常拖拽、平移完全不受影响。",
      ...
      "最后想跟大家说一声谢谢——这段时间收到的每一份打赏我都记在心里，真的很开心看到有人愿意支持这个小小的创作工具。会一直好好做下去的，有什么想法欢迎随时跟我说 ^^",
    ],
    images: [{ src: "/announcement-area-lock.svg", alt: "按住 Shift（Mac 为 Cmd）拖框选中星球，右键选择锁定位置", caption: "Shift（Mac：Cmd）+ 拖框选中，右键「锁定位置」即可固定星球排布" }],
  },
  {
