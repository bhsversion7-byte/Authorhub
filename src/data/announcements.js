export const ANNOUNCEMENTS = [
  {
    ...
    date: "2026-07-18",
    summary: "富文本、草稿本与星图体验更新：专注编辑、主题阅读与关系表现更稳定",
    ...
    sections: [
      ...
      {
        title: "星图、协作与交付稳定性",
        description: "星图现按单节点或关系双端点精确聚焦，双击节点可放大定位；任意“主角*”之间的关系线与标签固定为红色，选中节点以外圈呼吸提示，拖拽释放后会自然回稳。共同编辑提醒会区分作者与协作者，并标明对应 ID；本次也补齐了构建、迁移与线上冒烟门禁。",
      },
    ],
    images: [
