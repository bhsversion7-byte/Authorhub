export const ANNOUNCEMENTS = [
  {
    ...
    date: "2026-07-18",
    summary: "富文本、草稿本与星图体验更新：专注编辑、主题阅读、人物切换与协作操作更稳定",
    title: "7.18 更新：把灵感、长篇正文与人物关系放回更舒服的位置",
    body: [
      "本次更新围绕三类真实创作场景展开：长篇正文需要清楚的层级与重点标记；灵感出现时需要不打断当前页面的记录空间；人物关系需要既稳定又有反馈的可视化。以下功能均可在电脑、平板与手机尺寸下使用。",
    ],
    sections: [
      {
        title: "富文本与专注编辑器",
        why: "纯文本适合快速输入，但在大纲、设定集和线索密集的内容中，重点、层级与状态需要被明确区分。",
        description: "大纲、设定集、人物背景、隐藏设定、时间线剧情与草稿本共用同一套安全富文本能力；紧凑卡片正文可滚动、也可向下拖长，专注编辑器保存后的排版会同步显示在原文本框中。",
        steps: [
          "点击“大纲”或其他文本卡片右上角的放大按钮进入专注编辑器，再使用顶部“Aa 文本样式”，可调整加粗、斜体、下划线、删除线、六种文字颜色、对齐、列表、缩进与字号；保存后原卡片会直接显示完整排版。",
      ...
      },
      {
        ...
        description: "右侧草稿本属于当前登录账号，不进入小说分享或导出。文本会先即时写入本地，再自动同步云端；思维导图与正文保存在同一份私人草稿中，并会跟随全站字号、字体与深浅主题。",
        steps: [
          "点击右侧“草稿本”打开工作区；浅色模式为白底深藏青字，深色模式为深藏青底亮字。点击右上角“文本”或选中文字后右键即可打开完整样式，关闭、重新打开或刷新后仍会恢复内容。",
      ...
      {
        title: "星图、协作与交付稳定性",
        description: "星图现按单节点或关系双端点精确聚焦，双击节点可放大定位；任意“主角*”之间的关系线与标签固定为红色，选中节点以外圈呼吸提示，拖拽释放后会自然回稳。人物详情在未保存切换时会保持各自独立，作者与协作者的删除提示也会准确区分；本次同步修复已知问题，并补齐构建、迁移与线上冒烟门禁。",
      },
    ],
    images: [
