export const ANNOUNCEMENTS = [
  {
    ...
    body: [
      "人物关系星图新增了「区域锁定」：按住 Shift 键，用鼠标左键拖出一个方框，圈住想固定的几颗星球，松手后右键点一下，选「锁定位置」就行。锁定的星球外面会有一圈淡淡的方形虚线提醒你——之后不管怎么拖动其他星球、新增多少人物，被锁定的这几颗都不会再被打乱位置。想解开就再框一次，右键选「取消锁定」。平时不按 Shift 的正常拖拽、平移完全不受影响。",
